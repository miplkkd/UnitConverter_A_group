...
def _run_gui_input(qtbot, raw: str) -> str:
...
def test_u_gui_02_empty_input_format_error(qtbot):
    ...
    assert_matches_golden(_run_gui_input(qtbot, ""), "u_in_01_empty.approved.txt")
...
def test_u_gui_03_no_colon_format_error(qtbot):
    ...
    assert_matches_golden(_run_gui_input(qtbot, "meter"), "u_in_02_no_colon.approved.txt")
...
def test_u_gui_04_negative_value_rejected(qtbot):
    ...
    assert_matches_golden(
        _run_gui_input(qtbot, "meter:-1"), "u_in_03_negative.approved.txt"
    )
